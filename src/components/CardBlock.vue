...
<template>
  ...
  >
    ...
    <Button v-if="menuStore.getSelectedMenus.length > 0" class="flex absolute bottom-5 left-2 w-[calc(100%-20px)] justify-between  h-15  bg-primary text-white mt-25 rounded-2xl" :variant="null">
